...
export interface Job {
    ...
    cta_public_contato?: string;
    cta_public_email?: string;
    cta_public_link?: string;
    cta_public_endereco?: string;
    cta_public_observations_whatsapp?: string;
    cta_public_observations_email?: string;
    cta_public_observations_link?: string;
    cta_public_observations_endereco?: string;
}
