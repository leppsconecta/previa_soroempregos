  ...
  if (showModal) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-6 text-center tracking-tight">boas-vindas!</h2>
          ...
          <form onSubmit={handleNameSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={!name.trim()}
              className="w-full bg-orange-500 hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50 text-white font-bold py-4 rounded-2xl text-lg transition-all shadow-lg shadow-orange-100 dark:shadow-none"
            >
              começar agora
            </button>
          </form>
          ...
          <AnimatePresence mode="wait">
            {!isFinished ? (
              ...
              >
                ...
                <button
                  onClick={nextStep}
                  className="group w-full md:w-auto flex items-center justify-center gap-3 bg-orange-500 hover:bg-blue-600 active:bg-blue-700 text-white px-8 py-5 rounded-2xl font-bold text-lg transition-all duration-300 shadow-xl shadow-orange-100 dark:shadow-none"
                >
                  continuar lendo
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  <button 
                    ...
                    onClick={() => {
                      ...
                      window.open("https://pay.kiwify.com.br/hCg3rYk", "_blank");
                    }}
                    className="w-full bg-orange-500 hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50 text-white font-black py-6 rounded-2xl text-xl transition-all shadow-xl shadow-orange-100 dark:shadow-none flex items-center justify-center gap-3"
                  >
                  ...
                  <button 
                    ...
                    className={`w-full font-bold py-6 rounded-2xl text-xl transition-all flex items-center justify-center gap-3 shadow-xl ${
                      countdown > 0 
                  ...
                  >
                    ...
                    {countdown > 0 ? `carregando link do grupo (${countdown}s)` : "link liberado"}
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Link 
                    to="/" 
                    className="inline-block text-xs text-gray-400 dark:text-slate-500 hover:text-orange-500 dark:hover:text-orange-400 transition-colors uppercase tracking-widest font-bold underline-offset-4 hover:underline"
                  >
